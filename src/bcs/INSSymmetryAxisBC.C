...
Real
INSSymmetryAxisBC::computeQpResidual()
{
  ...
  // Apply BC that the derivative of the z-component of the velocity in the radial direction is
  // zero.
  switch (_component)
  {
    case 0:
...
Real
INSSymmetryAxisBC::computeQpJacobian()
{
  return 0.;
}
