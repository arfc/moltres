...
Transfinite Line{2:5,7:9} = 8;
Transfinite Surface{11,13};
Recombine Surface{11,13};
Extrude {{0, 0, 1}, {0, 0, 0}, Pi/2} {
  Surface{11,13}; Layers{2}; Recombine;
}
Extrude {{0, 0, 1}, {0, 0, 0}, Pi/2} {
  Surface{47, 30}; Layers{2}; Recombine;
}
Extrude {{0, 0, 1}, {0, 0, 0}, Pi/2} {
  Surface{64, 81}; Layers{2}; Recombine;
}
Extrude {{0, 0, 1}, {0, 0, 0}, Pi/2} {
  Surface{98, 115}; Layers{2}; Recombine;
}
