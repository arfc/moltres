...
[Transfers]
  [to_sub]
    ...
    variable = 'group1_diff group2_diff group3_diff group4_diff group5_diff group6_diff group7_diff group8_diff'
    to_multi_app = sub
  []
  [to_sub_k]
