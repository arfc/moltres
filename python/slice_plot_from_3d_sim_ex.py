...
ds = yt.load('/home/lindsayad/Dropbox/MSR_data/converged_gamma_heating_3d_steady_state/gamma_heating_newton.e', step=-1)
...
for field in ds.field_list:
    ...
    if field_type != 'all' or field_name != 'temp':
        continue
    slc = yt.SlicePlot(ds, 'z', field, origin='native', center=(actual_center[0], actual_center[1], actual_domain_widths[2]))
    ...
    slc.save('/home/lindsayad/publications/figures/3d_gamma_heating_z_slice_' + field_name + '.eps')
