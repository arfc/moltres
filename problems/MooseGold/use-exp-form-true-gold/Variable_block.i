...
[Executioner]
  ...
  # petsc_options_iname = '-pc_type -pc_factor_shift_type -pc_factor_shift_amount -ksp_type -snes_linesearch_minlambda -pc_factor_mat_solver_package -pc_factor_mat_ordering_type'
  # petsc_options_value = 'lu NONZERO 1.e-10 preonly 1e-3 superlu_dist natural'
  petsc_options_iname = '-pc_type -pc_factor_shift_type -pc_factor_shift_amount -ksp_type -snes_linesearch_minlambda -pc_factor_pivot_in_blocks'
  petsc_options_value = 'lu NONZERO 1.e-10 preonly 1e-3 true'
