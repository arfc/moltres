...
num_cells = 1;
height = 5; // p. 101 robertson design report part 1: 162.56
lc = 2*graph_sqc_rad;
...
Transfinite Line {8, 5, 6, 7} = 2;
Transfinite Line {2, 1, 4, 3} = 2;
...
// For index In {3:5}
fuel_out[] = Extrude {0, 0, height} { Surface{fuel_surfaces[index]}; Layers{1}; Recombine; };
...
fuel_sides += fuel_out[3];
EndIf
moder_out[] = Extrude {0, 0, height} { Surface{moder_surfaces[index]}; Layers{1}; Recombine; };
