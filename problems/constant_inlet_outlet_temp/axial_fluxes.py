...
msre_axial_data = np.loadtxt('/home/lindsayad/publications/figures/msre_axial_fluxes.csv',skiprows=1,delimiter=',')
fast_x = msre_axial_data[:,0]
fast_flux = msre_axial_data[:,1]
msre_thermal_axial_data = np.loadtxt('/home/lindsayad/publications/figures/msre_thermal_axial_flux.csv',skiprows=1,delimiter=',')
