...
msre_fast_radial_data = np.loadtxt(
    '/home/lindsayad/publications/figures/msre_fast_radial_flux.csv', skiprows=1, delimiter=',')
fast_x = msre_fast_radial_data[:, 0]
fast_flux = msre_fast_radial_data[:, 1]
msre_thermal_radial_data = np.loadtxt(
    '/home/lindsayad/publications/figures/msre_thermal_radial_flux.csv', skiprows=1, delimiter=',')
